...
<div class="method-group online clearfix">
	<div class="method idx0">
		...
		<div class="method-content">
			...
			As Habbo Moedas s�o gr�tis! A cada 3 horas, s�o acrescentados 20 moedas em sua conta para asegurar que voc� nunca fique sem dinheiro!
...
<script type="text/javascript">
			...
			{
				document.getElementById('credits-countdown').innerHTML = "<h3 style='color: darkgreen;'>Creditos actualizados</h3><p>Acabamos envi� una actualizaci�n de cr�ditos. Revise su inventario en Habbo</p>";
...
<div class="disclaimer" style="border: 0 !important;">
    <h3><span>Habbo Moedas gr�tis</span></h3>
    Nunca se cobrar�o pelas moedas, elas s�o gr�tis<br />
