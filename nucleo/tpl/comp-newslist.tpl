<div class="habblet-container ">		
						<div class="cbb clearfix default "> 
							...
							<h2 class="title">Not�cias <?php if ($mode == 'archive') { echo 'Archive'; } ?>
							</h2> 
...
if ($mode == 'recent')
{
	...
	echo '<a href="%www%/articles/archive">Mais not�cias &raquo;</a>';
}
