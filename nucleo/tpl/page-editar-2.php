...
if (isset($_POST['name'])) {
    $Nombre = $_POST['name'];
    $Grupos = db::query("SELECT * FROM groups_details WHERE name = ? LIMIT 1", $Nombre);

    $GetGrupo = $Grupos->fetch(2);
    ...
    <div class="habblet-container ">
        <div class="cbb clearfix blue ">
            ...
            <div class="box-content">
                <center>
                    Para editar basta trocar os valores abaixo. (A edi��o custa %creditos_grupos% moedas).<br>
                </center>
            </div>
    ...
    <div class="habblet-container ">
        <div class="cbb clearfix blue ">
            <h2 class="title">Informa��o do grupo</h2>
            <div class="box-content">
                <form action="%www%/editar_grupos?tercero&editar=informacion" method="post">
                    <center>
                        <b>T�tulo: <input type="text" name="titulo" id="titulo"
                                          value="<?php echo $GetGrupo['name']; ?>"></b>
                        <br><b>Descri��o: <input type="text" name="descripcion" id="descripcion"
                                                 value="<?php echo $GetGrupo['description']; ?>"></b>
                        <br>
                        <br>
        ...
        <div class="cbb clearfix blue ">
            ...
            <div class="box-content">
                <center>
                    ...
                    <br>Quer trocar? <a href="%www%/placasgrupos.html" target="_blank">clique aqui</a>, monte seu
                    emblema e cole o c�digo abaixo.
                    <br>
                    <br>
                    <form action="%www%/editar_grupos?tercero&editar=placa" method="post">
                        <input type="hidden" value="<?php echo $Nombre; ?>" name="nombre" id="nombre">
                        <input type="text" name="placas" id="placas" value="Digite seu c�digo">
                        <input type="submit" value="Feito">
                    </form>
                </center>
    ...
    <div class="habblet-container ">
        <div class="cbb clearfix blue ">
            ...
            <div class="box-content">
                <center>
                    O fundo do seu grupo �:<br><br>
                    <div class="webstore-item-preview <?php echo $GetGrupo['bg']; ?> Background">
                </center>
                <br>Acesse <a href="%www%/ajax_habblet/fondos.php" class="lightwindow page-options"
                              params="lightwindow_width=500,lightwindow_height=380">aqui</a> e escolha outro
                <br>
                <br>
                <form action="%www%/editar_grupos?tercero&editar=fondo" method="post">
                    <input type="hidden" value="<?php echo $Nombre; ?>" name="nombre" id="nombre">
                    <input type="text" name="fondo" id="fondo" value="Digite seu c�digo">
                    <input type="submit" value="Feito">
                </form>
                </center>
