...
$getBuyItem = dbquery("SELECT * FROM shop_rares WHERE enabled = '1' and id = '".$fid."' ORDER BY order_id ASC");
...
if($coins1>=$price){
$final = $coins1-$price;
dbquery("INSERT INTO items (user_id, room_id, base_item, x, y, z, rot, extra_data, wall_pos) values ('".$idusr."','0','".$furniid."','0','0','0','0','','')");
...
$getItems = dbquery("SELECT * FROM shop_rares WHERE enabled = '1' ORDER BY order_id ASC");
$i=0;
