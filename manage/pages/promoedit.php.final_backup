...
<p>Frontpage s�o pequenas descri��es do conte�do do seu post feitas manualmente que podem ser usadas em seu tema.</p> 
</div> 
</div> 


<div id="authordiv" class="postbox " > 
<div class="handlediv" title="Clique para expandir ou recolher."><br /></div><h3 class='hndle'><span>Categoria da Not�cia</span></h3> 
<div class="inside"> 
<label class="screen-reader-text" for="post_author_override">Categoria da Not�cia</label><select name='post_author_override' id='post_author_override' class=''> 
