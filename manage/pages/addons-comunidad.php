...
if($Config['activado'] == '1'){ echo '<a href="./ajax/confirm_desactivar_comunidad.php?nombre=' .$Config['nombre']. '" id="boton">Desactivar</a> '; }else{ echo '<a href="./ajax/confirm_activar_comunidad.php?nombre=' .$Config['nombre']. '" id="boton">Activar</a>';}
echo '<form name="formulario' .$Config['nombre'] . '" method="post" action="index.php?_cmd=editar_addon_comunidad"><input type="hidden" id="nombre" name="nombre" value="' .$Config['nombre']. '">
<a href="index.php?_cmd=editar_addon_comunidad&nombre=' .$Config['nombre']. '" id="boton">Editar</a> ';
echo '<a href="./ajax/confirm_borrar_comunidad.php?nombre=' .$Config['nombre']. '" id="boton" class="lightwindow page-options" params="lightwindow_width=640,lightwindow_height=290">Borrar</a>';
...
<br>
<br>
<a href="index.php?_cmd=nuevo_addon_comunidad" id="boton">Nuevo Addon</a>
