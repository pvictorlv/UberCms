...
if (isset($_POST['edit']))
{
	...
	db::query("UPDATE site_hotcampaigns SET image_url = '" . $image . "', caption = '" . $title . "', descr = '" . $descr . "', enabled = '" . $enabled . "', order_id = '" . $order . "', url = '" . $url . "' WHERE id = '" . $id . "' LIMIT 1");
...
if (isset($_POST['add-new']))
{
	...
	db::query("INSERT INTO site_hotcampaigns (id,order_id,enabled,image_url,caption,descr,url) VALUES (NULL,'" . $order . "','" . $enabled . "','" . $image . "','" . $title . "','" . $descr . "','" . $url . "')");
	fMessage('ok', 'Noticion a�adido.');
}
...
<input type="hidden" name="add-new" value="1">
	...
	<td><input type="submit" value="A�adir"></td>
</form>
</tr>
</tbody>
</table>
