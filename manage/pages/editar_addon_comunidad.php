...
$Verificar11 = Db::query("SELECT * FROM site_addons_comunidad WHERE columna = '1' ORDER BY orden");
$Verificar22 = Db::query("SELECT * FROM site_addons_comunidad WHERE columna = '2' ORDER BY orden");
